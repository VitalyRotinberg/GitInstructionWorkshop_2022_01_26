...
Для ОС Linux достаточно ввести команду в терминале sudo apt-get install VS Code

**MacOS и Windows**

Для установки VSCode на MacOS и Windows необходимо перейти на сайт https://code.visualstudio.com/download, затем выбрать свою ОС и скачать установщик.

После того, как файл скачался необходимо его установить)
